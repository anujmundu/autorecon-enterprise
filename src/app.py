...
with col1:
    ...
    default_inv_path = Path(__file__).resolve().parent.parent / "data" / "invoices.csv"
...
with col2:
    ...
    default_bank_path = Path(__file__).resolve().parent.parent / "data" / "bank_statement.csv"
...
if can_run:
    try:
        ...
        # Excel Export
        st.markdown("---")
        temp_excel = Path(__file__).resolve().parent.parent / "data" / "temp_audit.xlsx"
